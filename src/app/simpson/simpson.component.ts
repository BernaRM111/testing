...
export class SimpsonComponent {
  ...
  calct9 = this.simpson((t: number) => this.tDistribution(t, 9), 0, 1.1, 10, 0.00001);
  calct10 = this.simpson((t: number) => this.tDistribution(t, 10), 0, 1.1812, 10, 0.00001);
  calct30 = this.simpson((t: number) => this.tDistribution(t, 30), 0, 2.750, 10, 0.00001);

  simpson(funcion: (x: number) => number, a: number, b: number, numSegmentos: number, error: number): number {
