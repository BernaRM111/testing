...
import { RegressionComponent, correlationCoefficient, r2 } from './regression.component';
...
describe('RegressionComponent', () => {
  ...
  it('Should return r=0.9545 with the dataset Data_Test1', waitForAsync(() => {
    fixture.whenStable().then(() => {
      expect(correlationCoefficient(component.x_test1, component.y_test1)).toBeCloseTo(0.9545, 2)
    });
  }));

  it('Should return rr=0.9111 with the dataset Data_Test1', waitForAsync(() => {
    fixture.whenStable().then(() => {
      expect(r2(component.x_test1, component.y_test1)).toBeCloseTo(0.9111, 2);
    })
  }));

  it('Should return r=0.9333 with the dataset Data_Test2', waitForAsync(() => {
    fixture.whenStable().then(() => {
      const result = correlationCoefficient(component.x_test2, component.y_test2);
  ...
  it('Should return rr=0.8711 with the dataset Data_Test2', waitForAsync(() => {
    fixture.whenStable().then(() => {
      const result = r2(component.x_test2, component.y_test2);
  ...
  it('Should return r=0.9631 with the dataset Data_Test3', waitForAsync(() => {
    fixture.whenStable().then(() => {
      const result = correlationCoefficient(component.x_test3, component.y_test3);
  ...
  it('Should return rr=0.9276 with the dataset Data_Test3', waitForAsync(() => {
    fixture.whenStable().then(() => {
      const result = r2(component.x_test3, component.y_test3);
  ...
  it('Should return r=0.9480 with the dataset Data_Test4', waitForAsync(() => {
    fixture.whenStable().then(() => {
      const result = correlationCoefficient(component.x_test4, component.y_test4);
  ...
  it('Should return rr=0.8988 with the dataset Data_Test4', waitForAsync(() => {
    fixture.whenStable().then(() => {
      const result = r2(component.x_test4, component.y_test4);
